 ...
 * @author Alex
 */
public class MetronomeTester extends javax.swing.JFrame {

    /**
     * Creates new form MetronomeTester
     */
    public MetronomeTester() {
        initComponents();
    }
...
//        jToggleButton1.setText("Stop Metronome");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MetronomeTester.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MetronomeTester().setVisible(true);
            }
        });
    }
